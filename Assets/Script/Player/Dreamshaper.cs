...
public class Dreamshaper : MonoBehaviour
{
    ...
    [HideInInspector]
    public PlayerCastOrb castOrb;

    [HideInInspector]
    public PlayerMeleeAttack melee;

    [HideInInspector]
    public PlayerUltimate ulti;

    [HideInInspector]
    public PlayerActionState action;

    [HideInInspector]
    public PlayerEnergy mana;
    ...
    void Awake()
    {
        ...
        saveLoad = GetComponent<PlayerSaveLoad>();
    }
    ...
    public void SetAllModulesEnabled(bool state)
    {
        ...
        Debug.Log(
            $"[Dreamshaper] SetAllModulesEnabled({state}) | "
